...
def is_likely_nyt_rejected_strict(word):
    ...
    legitimate_compounds = {
        'capo', 'coopt', 'copout', 'unapt', 'atop', 'upon', 'auto', 'coop', 'coup', 
        'pact', 'pant', 'pout', 'punt', 'putt', 'papa', 'pupa', 'poop', 'catnap',
        'topcoat', 'coupon', 'output', 'potato', 'pontoon', 'occupant'
    }
    ...
    if len(word) >= 7:
        ...
        for char in word:
            if char in vowels:
                ...
                current_consonant_streak = 0
                max_consecutive_vowels = max(max_consecutive_vowels, current_vowel_streak)
            elif char in consonants:
                current_consonant_streak += 1
                current_vowel_streak = 0
                max_consecutive_consonants = max(max_consecutive_consonants, current_consonant_streak)
