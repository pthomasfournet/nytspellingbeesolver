...
def test_word_filtering_comprehensive():
    ...
    try:
        ...
        print(f"✓ Inappropriate filter: {len(test_words)} -> {len(inappropriate_filtered)}")
...
def test_gpu_components_comprehensive():
    ...
    try:
        ...
        print(f"✓ GPU inappropriate filter: {len(test_words)} -> {len(inappropriate_filtered)}")
...
def test_configuration_and_edge_cases():
    ...
    try:
        ...
        print(f"✓ Confidence edge cases: empty={conf_empty:.1f}, normal={conf_normal:.1f}")
