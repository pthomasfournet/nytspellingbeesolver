...
from src.spelling_bee_solver.word_filtering import is_likely_nyt_rejected, get_word_confidence, is_proper_noun
...
def test_extreme_edge_cases():
    ...
    try:
        words = solver._download_dictionary("https://raw.githubusercontent.com/dwyl/english-words/master/words_alpha.txt")
    ...
    for word in edge_words:
        try:
            ...
            print(f"'{word[:20]}...': rejected={rejected}, conf={conf:.2f}, proper={proper}")
        except Exception as e:
