"""
Enhanced Confidence Scorer - Olympic Judges System
...
class EnhancedConfidenceScorer:
    ...
    def __init__(self, nyt_filter=None, google_common_words: Optional[Set[str]] = None):
        """Initialize the enhanced scorer with multi-judge system.
...
def create_enhanced_confidence_scorer(nyt_filter=None, google_common_words=None):
    """Factory function to create EnhancedConfidenceScorer.
